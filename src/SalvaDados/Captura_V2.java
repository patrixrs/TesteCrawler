...
public class Captura_V2 {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 1; i < 5; i++) {
            ...
            //preço
            dadosCapt = driver.findElement(By.xpath("//article[1]/section[@class='caracteristicas pull-left' and 1]/a[1]/div[@class='preco' and 1]/strong[1]")).getText();
            movel.setPreco(dadosCapt);
            //bairro
            dadosCapt = driver.findElement(By.xpath("//article[1]/section[@class='endereco pull-right' and 2]/a[1]/h2[1]/strong[1]")).getText();
            movel.setBairro(dadosCapt);
            //Quartos
            dadosCapt = driver.findElement(By.xpath("//li[@class='icone-quartos' and 1]")).getText();
            movel.setQuartos(dadosCapt);
            //Vagas
            dadosCapt = driver.findElement(By.xpath("//li[@class='icone-vagas' and 2]")).getText();
            movel.setVagas(dadosCapt);
            //Tamanho
            dadosCapt = driver.findElement(By.xpath("//li[@class='icone-area' and 3]")).getText();
            movel.setTamanho(dadosCapt);
            //Descrição
            dadosCapt = driver.findElement(By.xpath("//p[1]")).getText();
